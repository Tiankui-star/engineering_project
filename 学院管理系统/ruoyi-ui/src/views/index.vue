  ...
  <div class="dashboard-container">
    ...
    <el-row :gutter="20" class="charts-row">
      <el-col :xs="24" :sm="12" :md="8">
        <el-card shadow="hover">
          <div slot="header">教师职称分布</div>
          <pie-chart :data="facultyTitleData" height="300px" />
        </el-card>
      </el-col>
      <el-col :xs="24" :sm="12" :md="8">
        <el-card shadow="hover">
          <div slot="header">学生学籍状态</div>
          <pie-chart :data="studentStatusData" height="300px" />
        </el-card>
      </el-col>
      <el-col :xs="24" :sm="12" :md="8">
        <el-card shadow="hover">
          <div slot="header">项目级别分布</div>
          <pie-chart :data="projectLevelData" height="300px" />
        </el-card>
      </el-col>
    </el-row>
    ...
    <el-row :gutter="20" class="charts-row">
      <el-col :xs="24" :sm="12" :md="12">
        <el-card shadow="hover">
          <div slot="header">论文发表趋势</div>
          <line-chart :data="paperTrendData" height="350px" />
        </el-card>
      </el-col>
      <el-col :xs="24" :sm="12" :md="12">
        <el-card shadow="hover">
          <div slot="header">项目资金趋势</div>
          <line-chart :data="fundingTrendData" height="350px" />
        </el-card>
      </el-col>
    </el-row>
    ...
    <el-row :gutter="20" class="charts-row">
      <el-col :xs="24" :md="12">
        <el-card shadow="hover">
          <div slot="header">院系统计对比</div>
          <bar-chart :data="departmentData" height="400px" />
        </el-card>
      </el-col>
      <el-col :xs="24" :md="12">
        <el-card shadow="hover">
          <div slot="header">专利类型分布</div>
          <pie-chart :data="patentTypeData" height="400px" />
        </el-card>
      </el-col>
    </el-row>
  </div>
    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>学院后台管理框架</h2>
        <p>
          一直想做一款后台管理系统，看了很多优秀的开源项目但是发现没有合适自己的。于是利用空闲休息时间开始自己写一套后台系统。如此有了学院管理系统，她可以用于所有的Web应用程序，如网站管理后台，网站会员中心，CMS，CRM，OA等等，当然，您也可以对她进行深度定制，以做出更强系统。所有前端后台代码封装过后十分精简易上手，出错概率低。同时支持移动客户端访问。系统会陆续更新一些实用功能。
        </p>
        <p>
