...
public class FacultyController extends BaseController
{
    ...
    /**
     * 查询教职工信息及科研统计列表
     * 学生角色在论文/专利/项目表单需要加载教师列表（作者选择），因此扩展为 hasAnyPermi
     */
    @PreAuthorize("@ss.hasAnyPermi('Faculty:faculty:list,Paper:Paper:list,Patent:Patent:list,Project:project:list')")
    @GetMapping("/list")
