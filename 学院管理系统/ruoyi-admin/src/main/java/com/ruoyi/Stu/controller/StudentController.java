...
public class StudentController extends BaseController
{
    ...
    {
        if (student.getBirthDate() != null && student.getEnrollmentDate() != null
                && student.getBirthDate().after(student.getEnrollmentDate()))
        {
            return error("新增学生失败，出生日期不能晚于入学日期");
        }
    ...
    public AjaxResult edit(@RequestBody Student student)
    {
        if (student.getBirthDate() != null && student.getEnrollmentDate() != null
                && student.getBirthDate().after(student.getEnrollmentDate()))
        {
            return error("修改学生失败，出生日期不能晚于入学日期");
        }
